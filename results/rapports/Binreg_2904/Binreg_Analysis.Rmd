...
# Wide database heatmaps (ordered by mean of means on healthy tissues)
...
order_index <- order(apply(means_h_d,1,mean,na.rm=T))
...
order_index <- order(apply(means_h_c,1,mean,na.rm=T))
